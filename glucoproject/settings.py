"""
Django settings for glucoproject project.
...
SECRET_KEY = "django-insecure-n50jeg0rag(_7qa_1#ma0ld1ksua4cy^g2s4+elelwt(vdube7"
...
WSGI_APPLICATION = "glucoproject.wsgi.application"
